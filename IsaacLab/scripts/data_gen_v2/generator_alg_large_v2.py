"""
[File Description]
This script contains the core algorithm (FinalViewBuilder) to generate large 
convex structures using procedural plane cuts for the 'large' category.
Original name: generate_convex_bricks.py
