...
def run_batch(category):
    # 1. 设置路径
    json_folder = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../../assets/dataset/intermediate_json", category))
    script_name = "step2_render_images_single.py"
