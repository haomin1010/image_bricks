"""
[File Description]
This script is STEP 3 (Batch Processing) of the data generation pipeline.
It iterates through all coordinate JSON files generated by STEP 1 and 
automatically triggers STEP 2 for each one, collecting resulting images.
Original name: run_batch_gen.py
Usage: python step3_run_render_batch.py --type <category>
"""
...
def run_batch(category):
    # 1. 设置路径
    json_folder = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../../assets/dataset_v2/intermediate_json", category))
    script_name = "step2_render_images_single_v2.py"
