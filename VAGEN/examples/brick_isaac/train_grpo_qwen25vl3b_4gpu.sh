#!/bin/bash
# ============================================================================
# BrickIsaac – GRPO training with Qwen2.5-VL-3B (4 GPUs)
#
# Scaled-up GRPO with larger batch size. Suitable for multi-GPU nodes.
# Uses the mock backend for pipeline testing.
# ============================================================================

set -x

# ---- GPU selection (change to desired GPU IDs, e.g. 0,1,2,3 or 4,5,6,7) ----
export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0,1,2,3}

PROJECT_NAME="verl_vagen"
EXPERIMENT_NAME="brick_isaac_grpo_qwen25vl3b_4gpu"

BASEDIR=$(pwd)
SCRIPTDIR=$(dirname "$0")
EXPERIMENT_DIR=${BASEDIR}/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}
SAVE_CHECKPOINT_DIR=${EXPERIMENT_DIR}/verl_checkpoints
DATASET_TRAIN=${SCRIPTDIR}/train_brick_isaac_vision.yaml
DATASET_VAL=${SCRIPTDIR}/val_brick_isaac_vision.yaml
...
PYTHONUNBUFFERED=1 python3 -m vagen.main_ppo \
    ...
    2>&1 | tee ${EXPERIMENT_DIR}/${PROJECT_NAME}_${EXPERIMENT_NAME}.log \
               >(tee ${BASEDIR}/${PROJECT_NAME}_${EXPERIMENT_NAME}.log >/dev/null)
