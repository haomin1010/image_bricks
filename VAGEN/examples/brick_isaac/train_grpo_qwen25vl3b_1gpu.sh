#!/bin/bash
# ============================================================================
# BrickIsaac – GRPO training with Qwen2.5-VL-3B (single GPU)
#
# Uses the mock backend for pipeline testing. Change backend to "isaac" in
# the YAML configs when the real simulator is ready.
# ============================================================================
