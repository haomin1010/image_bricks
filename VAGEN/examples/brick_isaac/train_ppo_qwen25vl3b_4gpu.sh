#!/bin/bash
# ============================================================================
# BrickIsaac – PPO training with Qwen2.5-VL-3B (4 GPUs)
#
# PPO uses GAE advantage estimation and requires a critic model.
...
EXPERIMENT_NAME="brick_isaac_ppo_qwen25vl3b_4gpu"
