"""
[File Description]
This script contains the core algorithm (SmallBricksBuilder) to generate purely 
random connected structures for the 'small' and 'small_size4' categories.
Original name: generate_small_bricks.py
Usage: Imported by step1_generate_json_batch.py
"""
