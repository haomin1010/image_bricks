"""
[File Description]
This is a utility script that can reorder or normalize block indices in a JSON.
Original name: reorder_json.py
Usage: python util_reorder_json.py (needs manual config of input directories inside)
"""
