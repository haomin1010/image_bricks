...
from generator_alg_large_v2 import FinalViewBuilder
from generator_alg_small_v2 import SmallBricksBuilder
...
def generate_batch(category, num_samples, output_base="../../../assets/dataset_v2/intermediate_json"):
    """批量生成指定数量和类别的数据"""
