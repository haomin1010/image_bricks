...
from vagen.evaluate.clients import build_client_qwen
from vagen.evaluate.adapters.openai_adapter import OpenAIAdapter
from vagen.evaluate.adapters.qwen_adapter import QwenAdapter
...
REGISTRY.register_client("qwen",     build_client_qwen)
...
REGISTRY.register_adapter("qwen",     lambda **k: QwenAdapter(**k))
